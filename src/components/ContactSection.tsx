...
export function ContactSection() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    console.log("[Manarт] Заявка на бронирование:", formData)
  }
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-balance">
            Забронируйте <span className="text-primary">свой столик</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-pretty leading-relaxed">
            Оставьте заявку и мы свяжемся с вами в течение 15 минут для подтверждения.
          </p>
        </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      onChange={handleChange}
                      placeholder="Количество гостей, зал или VIP, особые пожелания..."
                      rows={4}
                      className="transition-all focus:scale-[1.02]"
                    />
                  </div>
